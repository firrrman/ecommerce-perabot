...
export default function CustomerRegisterPage() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-blueprimary p-6 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md relative z-10 my-6 flex flex-col gap-4">
        ...
        <div className="w-full border border-gray-100 shadow-2xl rounded-2xl bg-whiteprimary p-8 sm:p-10 flex flex-col gap-6">
          ...
          <div className="text-center flex flex-col items-center gap-3">
            ...
            <p className="text-xs font-bold text-blueprimary uppercase tracking-widest mt-1">
              Daftar Akun
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                  <User className="w-5 h-5 text-blueprimary" />
                </div>
                <input
                  type="text"
                  name="name"
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                  <Phone className="w-5 h-5 text-blueprimary" />
                </div>
                <input
                  type="tel"
                  name="phone"
