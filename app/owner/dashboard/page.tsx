      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 bg-slate-50">
                ...
                {bestSellers.map((product, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="w-6 h-6 rounded-lg bg-indigo-50 text-blueprimary font-extrabold text-xs flex items-center justify-center shrink-0">
                        {index + 1}
                      </span>
                      <div>
                    ...
                    <span className="text-xs font-black text-blueprimary bg-indigo-50 px-2.5 py-1 rounded-lg shrink-0">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <TransitionLink
              href={"/owner/produk"}
              className="bg-white rounded-2xl shadow border border-blackprimary/30 p-4 hover:shadow-md transition-all flex items-center gap-4 cursor-pointer group"
            >
